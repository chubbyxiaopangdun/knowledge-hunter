...
本技能的核心功能需要向以下**非虾评平台**的外部服务发起网络请求：

| 服务类型 | 域名 | 用途 | 数据流向 | 风险等级 |
|---------|------|------|---------|---------|
| B站API | `api.bilibili.com` | 获取视频信息、字幕 | **发送**: Cookie(SESSDATA) **接收**: 视频数据 | 🔴 高 |
...
| 飞书 | `open.feishu.cn` | 同步知识库 | **发送**: 转录内容 | 🟢 低 |
